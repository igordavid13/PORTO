...
def mostra_navios_persistencia():
...
def mostra_equipes_persistencia():
...
def mostra_atividades_navios_persistencia():
...
def mostra_funcionarios_persistencia():
...
def mostra_caminhoes_persistencia():
...
def mostra_empilhadeiras_persistencia():
...
def mostra_atividades_porto_persistencia():
...
def mostra_containers_persistencia():
